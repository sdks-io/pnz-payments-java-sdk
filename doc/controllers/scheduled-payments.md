...
```java
ScheduledPaymentsController scheduledPaymentsController = client.getScheduledPaymentsController();
```
...
```java
CompletableFuture<GetAccountScheduledPaymentsResponse> getAccountScheduledPaymentsAsync(
...
scheduledPaymentsController.getAccountScheduledPaymentsAsync(accountId, null, null, null, null, null).thenAccept(result -> {
...
|  --- | --- | --- |
| 400 | Bad Request | [`AccountsScheduledPayments400ErrorException`](../../doc/models/accounts-scheduled-payments-400-error-exception.md) |
| 401 | Unauthorized | `ApiException` |
| 403 | Forbidden | [`AccountsScheduledPayments403ErrorException`](../../doc/models/accounts-scheduled-payments-403-error-exception.md) |
| 405 | Method Not Allowed | `ApiException` |
| 406 | Not Acceptable | `ApiException` |
| 429 | Too Many Requests | `ApiException` |
| 500 | Internal Server Error | [`AccountsScheduledPayments500ErrorException`](../../doc/models/accounts-scheduled-payments-500-error-exception.md) |
| 501 | Not Implemented | `ApiException` |
| 503 | Service Unavailable | [`AccountsScheduledPayments503ErrorException`](../../doc/models/accounts-scheduled-payments-503-error-exception.md) |
...
```java
CompletableFuture<GetScheduledPaymentsResponse> getScheduledPaymentsAsync(
    final String xFapiAuthDate,
    final String xFapiCustomerIpAddress,
    final String xFapiInteractionId,
    final String xMerchantIpAddress,
...
```java
scheduledPaymentsController.getScheduledPaymentsAsync(null, null, null, null, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
| HTTP Status Code | Error Description | Exception Class |
|  --- | --- | --- |
| 400 | Bad Request | [`ScheduledPayments400ErrorException`](../../doc/models/scheduled-payments-400-error-exception.md) |
| 401 | Unauthorized | `ApiException` |
| 403 | Forbidden | [`ScheduledPayments403ErrorException`](../../doc/models/scheduled-payments-403-error-exception.md) |
| 405 | Method Not Allowed | `ApiException` |
| 406 | Not Acceptable | `ApiException` |
| 429 | Too Many Requests | `ApiException` |
| 500 | Internal Server Error | [`ScheduledPayments500ErrorException`](../../doc/models/scheduled-payments-500-error-exception.md) |
| 501 | Not Implemented | `ApiException` |
| 503 | Service Unavailable | [`ScheduledPayments503ErrorException`](../../doc/models/scheduled-payments-503-error-exception.md) |
