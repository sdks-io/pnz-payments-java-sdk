...
```java
StandingOrdersController standingOrdersController = client.getStandingOrdersController();
```
...
```java
CompletableFuture<StandingOrdersResponse> getAccountStandingOrdersAsync(
...
[`StandingOrdersResponse`](../../doc/models/standing-orders-response.md)
...
standingOrdersController.getAccountStandingOrdersAsync(accountId, null, null, null, null, null).thenAccept(result -> {
...
|  --- | --- | --- |
| 400 | Bad Request | [`AccountsStandingOrders400ErrorException`](../../doc/models/accounts-standing-orders-400-error-exception.md) |
| 401 | Unauthorized | `ApiException` |
| 403 | Forbidden | [`AccountsStandingOrders403ErrorException`](../../doc/models/accounts-standing-orders-403-error-exception.md) |
| 405 | Method Not Allowed | `ApiException` |
| 406 | Not Acceptable | `ApiException` |
| 429 | Too Many Requests | `ApiException` |
| 500 | Internal Server Error | [`AccountsStandingOrders500ErrorException`](../../doc/models/accounts-standing-orders-500-error-exception.md) |
| 501 | Not Implemented | `ApiException` |
| 503 | Service Unavailable | [`AccountsStandingOrders503ErrorException`](../../doc/models/accounts-standing-orders-503-error-exception.md) |
...
```java
CompletableFuture<StandingOrdersResponse> getStandingOrdersAsync(
    final String xFapiAuthDate,
    final String xFapiCustomerIpAddress,
    final String xFapiInteractionId,
    final String xMerchantIpAddress,
...
```java
standingOrdersController.getStandingOrdersAsync(null, null, null, null, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
| HTTP Status Code | Error Description | Exception Class |
|  --- | --- | --- |
| 400 | Bad Request | [`StandingOrders400ErrorException`](../../doc/models/standing-orders-400-error-exception.md) |
| 401 | Unauthorized | `ApiException` |
| 403 | Forbidden | [`StandingOrders403ErrorException`](../../doc/models/standing-orders-403-error-exception.md) |
| 405 | Method Not Allowed | `ApiException` |
| 406 | Not Acceptable | `ApiException` |
| 429 | Too Many Requests | `ApiException` |
| 500 | Internal Server Error | [`StandingOrders500ErrorException`](../../doc/models/standing-orders-500-error-exception.md) |
| 501 | Not Implemented | `ApiException` |
| 503 | Service Unavailable | [`StandingOrders503ErrorException`](../../doc/models/standing-orders-503-error-exception.md) |
