...
|  --- | --- | --- | --- | --- | --- |
| `Transaction` | [`List<TransactionModel>`](../../doc/models/transaction-model.md) | Optional | Transaction | List<TransactionModel> getTransaction() | setTransaction(List<TransactionModel> transaction) |
