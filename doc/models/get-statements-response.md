...
|  --- | --- | --- | --- | --- | --- |
| `Data` | [`GetStatementsResponseData`](../../doc/models/get-statements-response-data.md) | Required | - | GetStatementsResponseData getData() | setData(GetStatementsResponseData data) |
