...
|  --- | --- | --- | --- | --- | --- |
| `Data` | [`GetAccountStatementsResponseData`](../../doc/models/get-account-statements-response-data.md) | Required | - | GetAccountStatementsResponseData getData() | setData(GetAccountStatementsResponseData data) |
