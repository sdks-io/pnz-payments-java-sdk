...
/**
 * This is a model class for AccountsBalances503ErrorException type.
 */
public class AccountsBalances503ErrorException extends ApiException {
    private static final long serialVersionUID = -2402598438460628228L;
    private String code;
    private String id;
     ...
     */
    public AccountsBalances503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsBalances503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsBalances503ErrorException [" + "statusCode=" + getResponseCode()
