...
/**
 * This is a model class for Offers503ErrorException type.
 */
public class Offers503ErrorException extends ApiException {
    private static final long serialVersionUID = 6483822474579869340L;
    private String code;
    private String id;
     ...
     */
    public Offers503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Offers503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Offers503ErrorException [" + "statusCode=" + getResponseCode() + ", message="
