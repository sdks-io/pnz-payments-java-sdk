...
/**
 * This is a model class for Transactions500ErrorException type.
 */
public class Transactions500ErrorException extends ApiException {
    private static final long serialVersionUID = 7985797932216032115L;
    private String code;
    private String id;
     ...
     */
    public Transactions500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Transactions500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Transactions500ErrorException [" + "statusCode=" + getResponseCode() + ", message="
