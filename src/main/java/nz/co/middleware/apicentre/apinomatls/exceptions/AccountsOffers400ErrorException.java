...
/**
 * This is a model class for AccountsOffers400ErrorException type.
 */
public class AccountsOffers400ErrorException extends ApiException {
    private static final long serialVersionUID = 662052154080476476L;
    private String code;
    private String id;
     ...
     */
    public AccountsOffers400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsOffers400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsOffers400ErrorException [" + "statusCode=" + getResponseCode()
