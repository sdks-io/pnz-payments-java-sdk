...
/**
 * This is a model class for DirectDebits503ErrorException type.
 */
public class DirectDebits503ErrorException extends ApiException {
    private static final long serialVersionUID = -5936822259608176929L;
    private String code;
    private String id;
     ...
     */
    public DirectDebits503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this DirectDebits503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DirectDebits503ErrorException [" + "statusCode=" + getResponseCode() + ", message="
