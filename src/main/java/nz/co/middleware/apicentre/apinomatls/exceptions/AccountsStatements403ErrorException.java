...
/**
 * This is a model class for AccountsStatements403ErrorException type.
 */
public class AccountsStatements403ErrorException extends ApiException {
    private static final long serialVersionUID = -255514120154580302L;
    private String code;
    private String id;
     ...
     */
    public AccountsStatements403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsStatements403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsStatements403ErrorException [" + "statusCode=" + getResponseCode()
