...
/**
 * This is a model class for Transactions503ErrorException type.
 */
public class Transactions503ErrorException extends ApiException {
    private static final long serialVersionUID = 7267388293475141972L;
    private String code;
    private String id;
     ...
     */
    public Transactions503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Transactions503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Transactions503ErrorException [" + "statusCode=" + getResponseCode() + ", message="
