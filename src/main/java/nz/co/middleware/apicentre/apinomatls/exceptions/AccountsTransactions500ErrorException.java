...
/**
 * This is a model class for AccountsTransactions500ErrorException type.
 */
public class AccountsTransactions500ErrorException extends ApiException {
    private static final long serialVersionUID = -4783658708978696077L;
    private String code;
    private String id;
     ...
     */
    public AccountsTransactions500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsTransactions500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsTransactions500ErrorException [" + "statusCode=" + getResponseCode()
