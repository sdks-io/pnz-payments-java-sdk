...
/**
 * This is a model class for AccountsStandingOrders503ErrorException type.
 */
public class AccountsStandingOrders503ErrorException extends ApiException {
    private static final long serialVersionUID = 3613702218285511912L;
    private String code;
    private String id;
     ...
     */
    public AccountsStandingOrders503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsStandingOrders503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsStandingOrders503ErrorException [" + "statusCode=" + getResponseCode()
