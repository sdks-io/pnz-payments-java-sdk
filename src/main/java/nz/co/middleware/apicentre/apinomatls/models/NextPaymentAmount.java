...
/**
 * This is a model class for NextPaymentAmount type.
 */
public class NextPaymentAmount {
    ...
    /**
     * Converts this NextPaymentAmount into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "NextPaymentAmount [" + "amount=" + amount + ", currency=" + currency + "]";
    }

    /**
     * Builds a new {@link NextPaymentAmount.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link NextPaymentAmount.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link NextPaymentAmount}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link NextPaymentAmount} object using the set fields.
         * @return {@link NextPaymentAmount}
         */
        public NextPaymentAmount build() {
            return new NextPaymentAmount(amount, currency);
        }
    }
}
