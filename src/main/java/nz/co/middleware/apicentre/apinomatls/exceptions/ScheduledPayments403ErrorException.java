...
/**
 * This is a model class for ScheduledPayments403ErrorException type.
 */
public class ScheduledPayments403ErrorException extends ApiException {
    private static final long serialVersionUID = 602709320183349018L;
    private String code;
    private String id;
     ...
     */
    public ScheduledPayments403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this ScheduledPayments403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ScheduledPayments403ErrorException [" + "statusCode=" + getResponseCode()
