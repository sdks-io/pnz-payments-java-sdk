...
/**
 * This is a model class for AccountsStandingOrders403ErrorException type.
 */
public class AccountsStandingOrders403ErrorException extends ApiException {
    private static final long serialVersionUID = 2469381145385460409L;
    private String code;
    private String id;
     ...
     */
    public AccountsStandingOrders403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsStandingOrders403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsStandingOrders403ErrorException [" + "statusCode=" + getResponseCode()
