...
/**
 * This is a model class for AccountsTransactions400ErrorException type.
 */
public class AccountsTransactions400ErrorException extends ApiException {
    private static final long serialVersionUID = -8511636222262190172L;
    private String code;
    private String id;
     ...
     */
    public AccountsTransactions400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsTransactions400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsTransactions400ErrorException [" + "statusCode=" + getResponseCode()
