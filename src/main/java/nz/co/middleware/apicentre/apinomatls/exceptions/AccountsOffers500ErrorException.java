...
/**
 * This is a model class for AccountsOffers500ErrorException type.
 */
public class AccountsOffers500ErrorException extends ApiException {
    private static final long serialVersionUID = -6410534507897950191L;
    private String code;
    private String id;
     ...
     */
    public AccountsOffers500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsOffers500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsOffers500ErrorException [" + "statusCode=" + getResponseCode()
