...
/**
 * This is a model class for StandingOrders400ErrorException type.
 */
public class StandingOrders400ErrorException extends ApiException {
    private static final long serialVersionUID = 522289016331859532L;
    private String code;
    private String id;
     ...
     */
    public StandingOrders400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this StandingOrders400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "StandingOrders400ErrorException [" + "statusCode=" + getResponseCode()
