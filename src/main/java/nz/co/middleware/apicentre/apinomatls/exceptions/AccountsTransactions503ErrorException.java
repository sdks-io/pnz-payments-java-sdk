...
/**
 * This is a model class for AccountsTransactions503ErrorException type.
 */
public class AccountsTransactions503ErrorException extends ApiException {
    private static final long serialVersionUID = -1948954345378138806L;
    private String code;
    private String id;
     ...
     */
    public AccountsTransactions503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsTransactions503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsTransactions503ErrorException [" + "statusCode=" + getResponseCode()
