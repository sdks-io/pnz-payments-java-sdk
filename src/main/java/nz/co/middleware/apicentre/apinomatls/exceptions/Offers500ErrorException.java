...
/**
 * This is a model class for Offers500ErrorException type.
 */
public class Offers500ErrorException extends ApiException {
    private static final long serialVersionUID = -8379253357073257699L;
    private String code;
    private String id;
     ...
     */
    public Offers500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Offers500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Offers500ErrorException [" + "statusCode=" + getResponseCode() + ", message="
