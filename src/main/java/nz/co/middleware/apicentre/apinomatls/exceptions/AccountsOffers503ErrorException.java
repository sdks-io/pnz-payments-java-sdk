...
/**
 * This is a model class for AccountsOffers503ErrorException type.
 */
public class AccountsOffers503ErrorException extends ApiException {
    private static final long serialVersionUID = 4584795705494352482L;
    private String code;
    private String id;
     ...
     */
    public AccountsOffers503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsOffers503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsOffers503ErrorException [" + "statusCode=" + getResponseCode()
