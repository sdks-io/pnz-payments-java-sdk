...
/**
 * This is a model class for Statements400ErrorException type.
 */
public class Statements400ErrorException extends ApiException {
    private static final long serialVersionUID = -8859243368899383685L;
    private String code;
    private String id;
     ...
     */
    public Statements400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Statements400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Statements400ErrorException [" + "statusCode=" + getResponseCode() + ", message="
