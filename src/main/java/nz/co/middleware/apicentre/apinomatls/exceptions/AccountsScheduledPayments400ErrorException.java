...
/**
 * This is a model class for AccountsScheduledPayments400ErrorException type.
 */
public class AccountsScheduledPayments400ErrorException extends ApiException {
    private static final long serialVersionUID = 4063857852679270983L;
    private String code;
    private String id;
     ...
     */
    public AccountsScheduledPayments400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsScheduledPayments400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsScheduledPayments400ErrorException [" + "statusCode=" + getResponseCode()
