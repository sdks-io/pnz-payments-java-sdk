...
/**
 * This is a model class for ScheduledPayments503ErrorException type.
 */
public class ScheduledPayments503ErrorException extends ApiException {
    private static final long serialVersionUID = -3374560505697855859L;
    private String code;
    private String id;
     ...
     */
    public ScheduledPayments503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this ScheduledPayments503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ScheduledPayments503ErrorException [" + "statusCode=" + getResponseCode()
