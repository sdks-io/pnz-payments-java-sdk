...
/**
 * This is a model class for Party400ErrorException type.
 */
public class Party400ErrorException extends ApiException {
    private static final long serialVersionUID = 5248704955192215265L;
    private String code;
    private String id;
     ...
     */
    public Party400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Party400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Party400ErrorException [" + "statusCode=" + getResponseCode() + ", message="
