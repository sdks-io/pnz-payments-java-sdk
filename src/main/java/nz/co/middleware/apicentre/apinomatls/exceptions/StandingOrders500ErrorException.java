...
/**
 * This is a model class for StandingOrders500ErrorException type.
 */
public class StandingOrders500ErrorException extends ApiException {
    private static final long serialVersionUID = 6384914986511650107L;
    private String code;
    private String id;
     ...
     */
    public StandingOrders500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this StandingOrders500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "StandingOrders500ErrorException [" + "statusCode=" + getResponseCode()
