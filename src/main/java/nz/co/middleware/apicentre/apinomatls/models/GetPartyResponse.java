...
/**
 * This is a model class for GetPartyResponse type.
 */
public class GetPartyResponse {
    ...
    /**
     * Converts this GetPartyResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "GetPartyResponse [" + "data=" + data + ", links=" + links + ", meta=" + meta + "]";
    }

    /**
     * Builds a new {@link GetPartyResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link GetPartyResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link GetPartyResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link GetPartyResponse} object using the set fields.
         * @return {@link GetPartyResponse}
         */
        public GetPartyResponse build() {
            return new GetPartyResponse(data, links, meta);
        }
    }
}
