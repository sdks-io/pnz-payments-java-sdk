...
/**
 * This is a model class for Accounts400ErrorException type.
 */
public class Accounts400ErrorException extends ApiException {
    private static final long serialVersionUID = 6992260549000730597L;
    private String code;
    private String id;
     ...
     */
    public Accounts400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Accounts400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Accounts400ErrorException [" + "statusCode=" + getResponseCode() + ", message="
