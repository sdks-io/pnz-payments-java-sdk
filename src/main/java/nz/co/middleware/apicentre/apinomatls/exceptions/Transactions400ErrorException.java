...
/**
 * This is a model class for Transactions400ErrorException type.
 */
public class Transactions400ErrorException extends ApiException {
    private static final long serialVersionUID = -5996198898661741342L;
    private String code;
    private String id;
     ...
     */
    public Transactions400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Transactions400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Transactions400ErrorException [" + "statusCode=" + getResponseCode() + ", message="
