...
/**
 * This is a model class for AccountsOffers403ErrorException type.
 */
public class AccountsOffers403ErrorException extends ApiException {
    private static final long serialVersionUID = -6236235286865183145L;
    private String code;
    private String id;
     ...
     */
    public AccountsOffers403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsOffers403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsOffers403ErrorException [" + "statusCode=" + getResponseCode()
