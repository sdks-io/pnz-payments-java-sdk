...
/**
 * This is a model class for Party503ErrorException type.
 */
public class Party503ErrorException extends ApiException {
    private static final long serialVersionUID = -2920685986044597209L;
    private String code;
    private String id;
     ...
     */
    public Party503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Party503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Party503ErrorException [" + "statusCode=" + getResponseCode() + ", message="
