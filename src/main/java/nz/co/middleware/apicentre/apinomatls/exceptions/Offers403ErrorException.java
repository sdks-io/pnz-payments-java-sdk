...
/**
 * This is a model class for Offers403ErrorException type.
 */
public class Offers403ErrorException extends ApiException {
    private static final long serialVersionUID = -5577846111237921297L;
    private String code;
    private String id;
     ...
     */
    public Offers403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Offers403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Offers403ErrorException [" + "statusCode=" + getResponseCode() + ", message="
