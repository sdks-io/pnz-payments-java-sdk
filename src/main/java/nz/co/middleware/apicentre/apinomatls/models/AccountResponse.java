...
public class AccountResponse {
     ...
     * @param  data  AccountResponseData value for data.
    ...
    /**
     * Getter for Data.
     * @return Returns the AccountResponseData
     */
    @JsonGetter("Data")
    ...
    /**
     * Setter for Data.
     * @param data Value for AccountResponseData
     */
    @JsonSetter("Data")
    ...
    public String toString() {
        return "AccountResponse [" + "data=" + data + ", links=" + links + ", meta=" + meta + "]";
    }
    ...
    public static class Builder {
         ...
         * @param  meta  Meta value for meta.
         */
        public Builder(AccountResponseData data, Links links, Meta meta) {
            this.data = data;
            this.links = links;
            this.meta = meta;
        }
         ...
         * @return Builder
         */
        public Builder data(AccountResponseData data) {
            this.data = data;
            return this;
        }
        ...
        public AccountResponse build() {
            return new AccountResponse(data, links, meta);
        }
    }
}
