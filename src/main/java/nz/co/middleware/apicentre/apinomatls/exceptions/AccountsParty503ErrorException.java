...
/**
 * This is a model class for AccountsParty503ErrorException type.
 */
public class AccountsParty503ErrorException extends ApiException {
    private static final long serialVersionUID = -5127312315919081709L;
    private String code;
    private String id;
     ...
     */
    public AccountsParty503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsParty503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsParty503ErrorException [" + "statusCode=" + getResponseCode() + ", message="
