...
/**
 * This is a model class for AccountsStandingOrders400ErrorException type.
 */
public class AccountsStandingOrders400ErrorException extends ApiException {
    private static final long serialVersionUID = -8959337271289456058L;
    private String code;
    private String id;
     ...
     */
    public AccountsStandingOrders400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsStandingOrders400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsStandingOrders400ErrorException [" + "statusCode=" + getResponseCode()
