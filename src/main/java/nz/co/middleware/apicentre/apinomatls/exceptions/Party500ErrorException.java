...
/**
 * This is a model class for Party500ErrorException type.
 */
public class Party500ErrorException extends ApiException {
    private static final long serialVersionUID = 946267685633156562L;
    private String code;
    private String id;
     ...
     */
    public Party500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Party500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Party500ErrorException [" + "statusCode=" + getResponseCode() + ", message="
