...
/**
 * This is a model class for Beneficiaries400ErrorException type.
 */
public class Beneficiaries400ErrorException extends ApiException {
    private static final long serialVersionUID = 2499246943141275276L;
    private String code;
    private String id;
     ...
     */
    public Beneficiaries400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Beneficiaries400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Beneficiaries400ErrorException [" + "statusCode=" + getResponseCode() + ", message="
