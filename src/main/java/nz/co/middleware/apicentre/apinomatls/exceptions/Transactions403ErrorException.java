...
/**
 * This is a model class for Transactions403ErrorException type.
 */
public class Transactions403ErrorException extends ApiException {
    private static final long serialVersionUID = 4110979363548856693L;
    private String code;
    private String id;
     ...
     */
    public Transactions403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Transactions403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Transactions403ErrorException [" + "statusCode=" + getResponseCode() + ", message="
