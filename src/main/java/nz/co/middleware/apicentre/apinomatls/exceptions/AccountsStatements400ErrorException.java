...
/**
 * This is a model class for AccountsStatements400ErrorException type.
 */
public class AccountsStatements400ErrorException extends ApiException {
    private static final long serialVersionUID = 7872958470661649723L;
    private String code;
    private String id;
     ...
     */
    public AccountsStatements400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsStatements400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsStatements400ErrorException [" + "statusCode=" + getResponseCode()
