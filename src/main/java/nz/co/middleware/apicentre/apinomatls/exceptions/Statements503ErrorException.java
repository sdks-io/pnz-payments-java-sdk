...
/**
 * This is a model class for Statements503ErrorException type.
 */
public class Statements503ErrorException extends ApiException {
    private static final long serialVersionUID = -5292986536784896803L;
    private String code;
    private String id;
     ...
     */
    public Statements503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Statements503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Statements503ErrorException [" + "statusCode=" + getResponseCode() + ", message="
