...
/**
 * This is a model class for ScheduledPayments400ErrorException type.
 */
public class ScheduledPayments400ErrorException extends ApiException {
    private static final long serialVersionUID = -5707932961132767905L;
    private String code;
    private String id;
     ...
     */
    public ScheduledPayments400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this ScheduledPayments400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ScheduledPayments400ErrorException [" + "statusCode=" + getResponseCode()
