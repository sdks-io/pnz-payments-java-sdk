...
/**
 * This is a model class for DirectDebits400ErrorException type.
 */
public class DirectDebits400ErrorException extends ApiException {
    private static final long serialVersionUID = -9161872227696528967L;
    private String code;
    private String id;
     ...
     */
    public DirectDebits400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this DirectDebits400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DirectDebits400ErrorException [" + "statusCode=" + getResponseCode() + ", message="
