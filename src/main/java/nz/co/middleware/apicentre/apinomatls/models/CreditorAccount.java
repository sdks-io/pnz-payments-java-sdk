...
/**
 * This is a model class for CreditorAccount type.
 */
public class CreditorAccount {
    ...
    /**
     * Converts this CreditorAccount into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CreditorAccount [" + "schemeName=" + schemeName + ", identification="
                + identification + ", name=" + name + ", secondaryIdentification="
                + secondaryIdentification + "]";
    }

    /**
     * Builds a new {@link CreditorAccount.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CreditorAccount.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CreditorAccount}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CreditorAccount} object using the set fields.
         * @return {@link CreditorAccount}
         */
        public CreditorAccount build() {
            return new CreditorAccount(schemeName, identification, name, secondaryIdentification);
        }
    }
}
