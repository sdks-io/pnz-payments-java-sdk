...
/**
 * This is a model class for AccountsScheduledPayments503ErrorException type.
 */
public class AccountsScheduledPayments503ErrorException extends ApiException {
    private static final long serialVersionUID = -3128129694911827071L;
    private String code;
    private String id;
     ...
     */
    public AccountsScheduledPayments503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsScheduledPayments503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsScheduledPayments503ErrorException [" + "statusCode=" + getResponseCode()
