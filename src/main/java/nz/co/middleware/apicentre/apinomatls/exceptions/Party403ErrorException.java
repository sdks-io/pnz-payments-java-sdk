...
/**
 * This is a model class for Party403ErrorException type.
 */
public class Party403ErrorException extends ApiException {
    private static final long serialVersionUID = -7000422150360753544L;
    private String code;
    private String id;
     ...
     */
    public Party403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Party403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Party403ErrorException [" + "statusCode=" + getResponseCode() + ", message="
