...
/**
 * This is a model class for AccountsScheduledPayments500ErrorException type.
 */
public class AccountsScheduledPayments500ErrorException extends ApiException {
    private static final long serialVersionUID = -712605180723984878L;
    private String code;
    private String id;
     ...
     */
    public AccountsScheduledPayments500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsScheduledPayments500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsScheduledPayments500ErrorException [" + "statusCode=" + getResponseCode()
