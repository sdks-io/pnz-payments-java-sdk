...
/**
 * This is a model class for Balances500ErrorException type.
 */
public class Balances500ErrorException extends ApiException {
    private static final long serialVersionUID = -8982824914816366465L;
    private String code;
    private String id;
     ...
     */
    public Balances500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Balances500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Balances500ErrorException [" + "statusCode=" + getResponseCode() + ", message="
