...
/**
 * This is a model class for Beneficiaries403ErrorException type.
 */
public class Beneficiaries403ErrorException extends ApiException {
    private static final long serialVersionUID = 4706632088885916737L;
    private String code;
    private String id;
     ...
     */
    public Beneficiaries403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Beneficiaries403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Beneficiaries403ErrorException [" + "statusCode=" + getResponseCode() + ", message="
                + getMessage() + ", code=" + code + ", id=" + id + ", message=" + message
                + ", errors=" + errors + "]";
    }
}
