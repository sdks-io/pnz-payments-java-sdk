...
/**
 * This is a model class for Statements500ErrorException type.
 */
public class Statements500ErrorException extends ApiException {
    private static final long serialVersionUID = 5067279073623642058L;
    private String code;
    private String id;
     ...
     */
    public Statements500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Statements500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Statements500ErrorException [" + "statusCode=" + getResponseCode() + ", message="
