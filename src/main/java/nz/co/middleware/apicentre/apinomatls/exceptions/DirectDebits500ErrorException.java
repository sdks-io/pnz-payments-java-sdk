...
/**
 * This is a model class for DirectDebits500ErrorException type.
 */
public class DirectDebits500ErrorException extends ApiException {
    private static final long serialVersionUID = -9061654834172442972L;
    private String code;
    private String id;
     ...
     */
    public DirectDebits500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this DirectDebits500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DirectDebits500ErrorException [" + "statusCode=" + getResponseCode() + ", message="
