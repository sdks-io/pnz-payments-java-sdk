...
/**
 * This is a model class for AccountsDirectDebits400ErrorException type.
 */
public class AccountsDirectDebits400ErrorException extends ApiException {
    private static final long serialVersionUID = -5116787642176018659L;
    private String code;
    private String id;
     ...
     */
    public AccountsDirectDebits400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsDirectDebits400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsDirectDebits400ErrorException [" + "statusCode=" + getResponseCode()
