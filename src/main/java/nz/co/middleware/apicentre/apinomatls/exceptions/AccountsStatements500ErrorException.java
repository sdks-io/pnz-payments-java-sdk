...
/**
 * This is a model class for AccountsStatements500ErrorException type.
 */
public class AccountsStatements500ErrorException extends ApiException {
    private static final long serialVersionUID = -3054620850387780148L;
    private String code;
    private String id;
     ...
     */
    public AccountsStatements500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsStatements500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsStatements500ErrorException [" + "statusCode=" + getResponseCode()
