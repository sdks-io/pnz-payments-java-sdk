...
/**
 * This is a model class for FinalPaymentAmount type.
 */
public class FinalPaymentAmount {
    ...
    /**
     * Converts this FinalPaymentAmount into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "FinalPaymentAmount [" + "amount=" + amount + ", currency=" + currency + "]";
    }

    /**
     * Builds a new {@link FinalPaymentAmount.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link FinalPaymentAmount.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link FinalPaymentAmount}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link FinalPaymentAmount} object using the set fields.
         * @return {@link FinalPaymentAmount}
         */
        public FinalPaymentAmount build() {
            return new FinalPaymentAmount(amount, currency);
        }
    }
}
