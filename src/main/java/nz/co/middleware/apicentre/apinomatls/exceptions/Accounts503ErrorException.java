...
/**
 * This is a model class for Accounts503ErrorException type.
 */
public class Accounts503ErrorException extends ApiException {
    private static final long serialVersionUID = 2482590875669570839L;
    private String code;
    private String id;
     ...
     */
    public Accounts503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Accounts503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Accounts503ErrorException [" + "statusCode=" + getResponseCode() + ", message="
