...
/**
 * This is a model class for ScheduledPayments500ErrorException type.
 */
public class ScheduledPayments500ErrorException extends ApiException {
    private static final long serialVersionUID = -204028034357664244L;
    private String code;
    private String id;
     ...
     */
    public ScheduledPayments500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this ScheduledPayments500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ScheduledPayments500ErrorException [" + "statusCode=" + getResponseCode()
