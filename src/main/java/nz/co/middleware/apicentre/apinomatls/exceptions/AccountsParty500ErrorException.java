...
/**
 * This is a model class for AccountsParty500ErrorException type.
 */
public class AccountsParty500ErrorException extends ApiException {
    private static final long serialVersionUID = -8899311170812502028L;
    private String code;
    private String id;
     ...
     */
    public AccountsParty500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsParty500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsParty500ErrorException [" + "statusCode=" + getResponseCode() + ", message="
