...
/**
 * This is a model class for AccountsBeneficiaries500ErrorException type.
 */
public class AccountsBeneficiaries500ErrorException extends ApiException {
    private static final long serialVersionUID = -7902122542331503533L;
    private String code;
    private String id;
     ...
     */
    public AccountsBeneficiaries500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsBeneficiaries500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsBeneficiaries500ErrorException [" + "statusCode=" + getResponseCode()
