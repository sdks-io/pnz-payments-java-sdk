...
/**
 * This is a model class for StandingOrders503ErrorException type.
 */
public class StandingOrders503ErrorException extends ApiException {
    private static final long serialVersionUID = -508934110416268250L;
    private String code;
    private String id;
     ...
     */
    public StandingOrders503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this StandingOrders503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "StandingOrders503ErrorException [" + "statusCode=" + getResponseCode()
