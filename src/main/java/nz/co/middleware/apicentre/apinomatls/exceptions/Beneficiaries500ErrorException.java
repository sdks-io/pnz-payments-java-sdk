...
/**
 * This is a model class for Beneficiaries500ErrorException type.
 */
public class Beneficiaries500ErrorException extends ApiException {
    private static final long serialVersionUID = 9222526542015537275L;
    private String code;
    private String id;
     ...
     */
    public Beneficiaries500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Beneficiaries500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Beneficiaries500ErrorException [" + "statusCode=" + getResponseCode() + ", message="
