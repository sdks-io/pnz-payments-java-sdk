...
/**
 * This is a model class for Balances503ErrorException type.
 */
public class Balances503ErrorException extends ApiException {
    private static final long serialVersionUID = -2083633569003212674L;
    private String code;
    private String id;
     ...
     */
    public Balances503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Balances503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Balances503ErrorException [" + "statusCode=" + getResponseCode() + ", message="
