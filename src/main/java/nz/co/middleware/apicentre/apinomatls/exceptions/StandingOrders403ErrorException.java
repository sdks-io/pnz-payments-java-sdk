...
/**
 * This is a model class for StandingOrders403ErrorException type.
 */
public class StandingOrders403ErrorException extends ApiException {
    private static final long serialVersionUID = -2766140138097606843L;
    private String code;
    private String id;
     ...
     */
    public StandingOrders403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this StandingOrders403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "StandingOrders403ErrorException [" + "statusCode=" + getResponseCode()
