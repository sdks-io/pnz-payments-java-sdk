...
/**
 * This is a model class for Accounts500ErrorException type.
 */
public class Accounts500ErrorException extends ApiException {
    private static final long serialVersionUID = -5023692199999149134L;
    private String code;
    private String id;
     ...
     */
    public Accounts500ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Accounts500ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Accounts500ErrorException [" + "statusCode=" + getResponseCode() + ", message="
