...
/**
 * This is a model class for AccountsParty403ErrorException type.
 */
public class AccountsParty403ErrorException extends ApiException {
    private static final long serialVersionUID = 717508953520769474L;
    private String code;
    private String id;
     ...
     */
    public AccountsParty403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsParty403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsParty403ErrorException [" + "statusCode=" + getResponseCode() + ", message="
