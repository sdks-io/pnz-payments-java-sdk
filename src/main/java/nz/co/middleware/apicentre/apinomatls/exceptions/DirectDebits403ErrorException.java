...
/**
 * This is a model class for DirectDebits403ErrorException type.
 */
public class DirectDebits403ErrorException extends ApiException {
    private static final long serialVersionUID = -1436766897535533046L;
    private String code;
    private String id;
     ...
     */
    public DirectDebits403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this DirectDebits403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DirectDebits403ErrorException [" + "statusCode=" + getResponseCode() + ", message="
