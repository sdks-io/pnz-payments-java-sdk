...
public class StatementAmount {
     ...
     * @param  type  StatementAmountTypeEnum value for type.
     */
    public StatementAmount(
            Amount amount,
            CreditDebitIndicatorEnum creditDebitIndicator,
            StatementAmountTypeEnum type) {
        this.amount = amount;
     ...
     * @return Returns the StatementAmountTypeEnum
     */
    @JsonGetter("Type")
    public StatementAmountTypeEnum getType() {
        return type;
    }
     ...
     * Setter for Type.
     * Amount type, in a coded form.
     * @param type Value for StatementAmountTypeEnum
     */
    @JsonSetter("Type")
    public void setType(StatementAmountTypeEnum type) {
        this.type = type;
    }

    /**
     * Converts this StatementAmount into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "StatementAmount [" + "amount=" + amount + ", creditDebitIndicator="
                + creditDebitIndicator + ", type=" + type + "]";
    }

    /**
     * Builds a new {@link StatementAmount.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link StatementAmount.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link StatementAmount}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder type(StatementAmountTypeEnum type) {
            this.type = type;
            return this;
        }

        /**
         * Builds a new {@link StatementAmount} object using the set fields.
         * @return {@link StatementAmount}
         */
        public StatementAmount build() {
            return new StatementAmount(amount, creditDebitIndicator, type);
        }
    }
}
