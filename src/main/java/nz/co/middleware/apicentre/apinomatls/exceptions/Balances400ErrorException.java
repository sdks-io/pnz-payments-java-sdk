...
/**
 * This is a model class for Balances400ErrorException type.
 */
public class Balances400ErrorException extends ApiException {
    private static final long serialVersionUID = 109372217359964460L;
    private String code;
    private String id;
     ...
     */
    public Balances400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Balances400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Balances400ErrorException [" + "statusCode=" + getResponseCode() + ", message="
