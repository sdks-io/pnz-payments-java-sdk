...
/**
 * This is a model class for Offers400ErrorException type.
 */
public class Offers400ErrorException extends ApiException {
    private static final long serialVersionUID = -1008476013476975126L;
    private String code;
    private String id;
     ...
     */
    public Offers400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Offers400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Offers400ErrorException [" + "statusCode=" + getResponseCode() + ", message="
