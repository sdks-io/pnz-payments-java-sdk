...
/**
 * This is a model class for Accounts403ErrorException type.
 */
public class Accounts403ErrorException extends ApiException {
    private static final long serialVersionUID = -8517072370612047260L;
    private String code;
    private String id;
     ...
     */
    public Accounts403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Accounts403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Accounts403ErrorException [" + "statusCode=" + getResponseCode() + ", message="
