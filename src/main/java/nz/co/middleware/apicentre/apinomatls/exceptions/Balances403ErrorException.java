...
/**
 * This is a model class for Balances403ErrorException type.
 */
public class Balances403ErrorException extends ApiException {
    private static final long serialVersionUID = 7711474087335403953L;
    private String code;
    private String id;
     ...
     */
    public Balances403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Balances403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Balances403ErrorException [" + "statusCode=" + getResponseCode() + ", message="
