...
/**
 * This is a model class for AccountsBeneficiaries400ErrorException type.
 */
public class AccountsBeneficiaries400ErrorException extends ApiException {
    private static final long serialVersionUID = -6275763550114262334L;
    private String code;
    private String id;
     ...
     */
    public AccountsBeneficiaries400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsBeneficiaries400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsBeneficiaries400ErrorException [" + "statusCode=" + getResponseCode()
