...
/**
 * This is a model class for AccountsScheduledPayments403ErrorException type.
 */
public class AccountsScheduledPayments403ErrorException extends ApiException {
    private static final long serialVersionUID = -2673709502480320468L;
    private String code;
    private String id;
     ...
     */
    public AccountsScheduledPayments403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsScheduledPayments403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsScheduledPayments403ErrorException [" + "statusCode=" + getResponseCode()
