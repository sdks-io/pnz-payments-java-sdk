...
/**
 * This is a model class for AccountsStatements503ErrorException type.
 */
public class AccountsStatements503ErrorException extends ApiException {
    private static final long serialVersionUID = -3078941922169394175L;
    private String code;
    private String id;
     ...
     */
    public AccountsStatements503ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsStatements503ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsStatements503ErrorException [" + "statusCode=" + getResponseCode()
