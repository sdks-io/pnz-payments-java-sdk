...
/**
 * This is a model class for AccountsParty400ErrorException type.
 */
public class AccountsParty400ErrorException extends ApiException {
    private static final long serialVersionUID = 634104446227181141L;
    private String code;
    private String id;
     ...
     */
    public AccountsParty400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsParty400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsParty400ErrorException [" + "statusCode=" + getResponseCode() + ", message="
