...
/**
 * This is a model class for AccountsBalances400ErrorException type.
 */
public class AccountsBalances400ErrorException extends ApiException {
    private static final long serialVersionUID = 6330531001471185110L;
    private String code;
    private String id;
     ...
     */
    public AccountsBalances400ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsBalances400ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsBalances400ErrorException [" + "statusCode=" + getResponseCode()
