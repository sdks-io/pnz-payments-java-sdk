...
/**
 * This is a model class for AccountsTransactions403ErrorException type.
 */
public class AccountsTransactions403ErrorException extends ApiException {
    private static final long serialVersionUID = 8751935050489714777L;
    private String code;
    private String id;
     ...
     */
    public AccountsTransactions403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this AccountsTransactions403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AccountsTransactions403ErrorException [" + "statusCode=" + getResponseCode()
