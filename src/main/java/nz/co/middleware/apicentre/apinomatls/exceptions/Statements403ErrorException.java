...
/**
 * This is a model class for Statements403ErrorException type.
 */
public class Statements403ErrorException extends ApiException {
    private static final long serialVersionUID = -6857468630309098052L;
    private String code;
    private String id;
     ...
     */
    public Statements403ErrorException(String reason, Context context) {
    ...
    /**
     * Converts this Statements403ErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Statements403ErrorException [" + "statusCode=" + getResponseCode() + ", message="
